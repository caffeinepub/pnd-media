  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M14 3V25", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function NarrativeIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "4", width: "18", height: "3", rx: "1.5", fill: "#18C6C3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "2",
...
function NetworkIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "11", cy: "11", r: "3", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "3", cy: "4", r: "2", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "19", cy: "4", r: "2", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "3", cy: "18", r: "2", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "19", cy: "18", r: "2", stroke: "#18C6C3", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
const pillars = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(NarrativeIcon, {}),
    title: "Narrative Structuring",
    description: "We define how your brand is perceived across every platform and touchpoint."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(NetworkIcon, {}),
    title: "Creator Networks",
    description: "Clippers, micro-creators, niche pages — activated and coordinated at scale."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformIcon, {}),
    title: "Cross-Platform Distribution",
    description: "X, TikTok, Instagram, YouTube Shorts — where your audience already lives."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ConversionIcon, {}),
    title: "Conversion Optimization",
    description: "We scale what works and cut what doesn't. Every cycle tightens the loop."
  }
];
const whyList = [
...
const useCases = [
  {
    ...
    description: "Structured distribution converts content spend into measurable growth."
  },
  {
    label: "For Platforms",
    title: "Backend growth layer",
    description: "Plug PND in as distribution infrastructure. Clipur and platforms like it use PND to grow."
  },
  {
    label: "For Operators / BD",
    title: "Close stronger deals",
    description: "Better outcomes mean better relationships. PND gives you results to stand behind."
  }
];
const campaigns = [
  {
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id, className: `py-24 md:py-32 ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 md:px-12", children }) });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CubeIcon, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold text-lg tracking-tight", children: "PND Media" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center dot-pattern overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background/0 via-background/60 to-background pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-6 md:px-12 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-border text-xs text-muted-foreground mb-8 tracking-wide uppercase", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary inline-block" }),
          "Distribution Infrastructure"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl md:text-7xl font-black tracking-tight text-foreground leading-[1.05] mb-6", children: [
          "Attention is everywhere.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#18C6C3" }, children: "Distribution is not." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "max-w-xl mx-auto text-lg text-muted-foreground leading-relaxed mb-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "The Reality" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground mb-16 leading-tight", children: "The reality of content in 2025." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 mb-6", children: truths.map((truth) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "p-6 rounded-xl border border-border bg-card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-foreground", children: truth })
        },
        truth
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-widest", children: "Result" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4", children: consequences.map((con) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "p-6 rounded-xl border border-border bg-card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-muted-foreground", children: con })
        },
        con
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "The Shift" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "PND is the distribution layer." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-0", children: shiftSteps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex-1 p-5 rounded-xl border border-border bg-card min-w-0",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-primary font-mono font-medium mb-2 block", children: [
                "0",
                i + 1
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: step })
            ]
          },
          step
        ),
        i < shiftSteps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "system", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "The System" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "Infrastructure, not a funnel." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-stretch gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 rounded-xl border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground mb-4", children: "Input" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: inputItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center gap-2 text-sm text-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-border flex-shrink-0" }),
                item
              ]
            },
            item
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center text-primary text-xl font-bold px-1", children: "→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: pndItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center gap-2 text-sm text-foreground",
                  children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center text-primary text-xl font-bold px-1", children: "→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 rounded-xl border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground mb-4", children: "Output" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: outputItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center gap-2 text-sm text-foreground",
              children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "pillars", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "Pillars" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "What powers PND." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: pillars.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: p.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-2", children: p.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: p.description })
          ]
        },
        p.title
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "Principles" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "Why this works." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: whyList.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center gap-5 py-5 border-b border-border last:border-0",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-mono text-primary w-6 flex-shrink-0", children: [
              "0",
              i + 1
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl md:text-3xl font-bold text-foreground", children: line })
          ]
        },
        line
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "use-cases", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "Use Cases" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "Built for internet brands." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4", children: useCases.map((uc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "p-7 rounded-xl border border-border bg-card hover:border-primary/30 transition-colors",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground mb-2", children: uc.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: uc.description })
          ]
        },
        uc.label
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "results", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary inline-block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary font-medium", children: "Results" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground mb-4 leading-tight", children: "The numbers don't lie." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "Every campaign below ran on X. Every impression is creator-confirmed. No bots." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1.5 uppercase tracking-wider", children: "Total Impressions" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl md:text-4xl font-black tracking-tight text-foreground", children: "4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1.5 uppercase tracking-wider", children: "Campaigns" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl md:text-4xl font-black tracking-tight text-foreground", children: "130+" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1.5 uppercase tracking-wider", children: "Verified Posts" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl md:text-4xl font-black tracking-tight text-foreground", children: "Jun–Sep" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1.5 uppercase tracking-wider", children: "2025" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5 mb-8", children: campaigns.map((c, i) => {
        ...
        const heroStyle = c.hero ? { borderColor: "#18C6C350", boxShadow: "0 0 40px #18C6C318" } : {};
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono", children: c.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: c.heroLabel }),
                c.heroLabel !== "impressions" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-0.5", children: c.exactFigure })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-x-5 gap-y-2", children: c.subStats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-bold text-foreground", children: s.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: s.label })
              ] }, s.label)) }),
              c.highlights.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: c.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center justify-between text-sm",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: h.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: h.value })
                  ]
                },
                h.label
              )) }),
              c.brands.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Brand breakdown" }),
                c.brands.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm mb-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: b.name }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full rounded-full bg-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
              ...
              c.note && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 italic border-t border-border pt-3", children: c.note }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground pt-2 border-t border-border mt-auto", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c.platform }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c.dates })
              ] })
            ]
          },
          c.id
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: 'All posts self-confirmed by creators: "I confirm this is my original post and I did not use any view bots." All included posts marked verified.'
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "how-it-works", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "Process" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight", children: "How it works." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 md:grid-cols-4 gap-4", children: howSteps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "p-7 rounded-xl border border-border bg-card",
          "data-ocid": `how.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-black text-foreground/10 mb-4 leading-none", children: step.num }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-1.5", children: step.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-black text-foreground leading-[1.05] mb-6", children: [
        "Content is easy.",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#18C6C3" }, children: "Conversion is engineered." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-10 max-w-md mx-auto", children: "PND is the system that bridges the gap between attention and revenue." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 md:px-12 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between gap-8 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CubeIcon, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold text-lg", children: "PND Media" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "Distribution Infrastructure for Internet Brands." })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiTiktok, { size: 16 })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: "campaigns@pndmedia.xyz"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          year,
          " PND Media. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
